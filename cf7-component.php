<div class="container">
    ...
    <div class="content">
        ...
        <input type="text" name="email" class="content__input" value= <?php echo $_SESSION["email"] ? $_SESSION["email"] : null ?>>
    </div>
    <div class="content">
        <h2 class="content__h2">電話番号</h2>
        <input type="text" name="tel" class="content__input" value= <?php echo $_SESSION["tel"] ? $_SESSION["tel"] : null ?>>
    </div>
